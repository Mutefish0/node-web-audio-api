...
function load(nativeBinding) {
    ...
    jsExport.OfflineAudioCompletionEvent =
        require("./js/Events").OfflineAudioCompletionEvent;
    jsExport.AudioProcessingEvent = require("./js/Events").AudioProcessingEvent;
    jsExport.AudioRenderCapacityEvent =
        require("./js/Events").AudioRenderCapacityEvent;
    // --------------------------------------------------------------------------
    // Create Web Audio API facade
    // --------------------------------------------------------------------------
    jsExport.BaseAudioContext = require("./js/BaseAudioContext.js")(
        jsExport,
        nativeBinding
    );
    jsExport.AudioContext = require("./js/AudioContext.js")(
        jsExport,
        nativeBinding
    );
    jsExport.OfflineAudioContext = require("./js/OfflineAudioContext.js")(
        jsExport,
        nativeBinding
    );

    jsExport.ScriptProcessorNode = require("./js/ScriptProcessorNode.js")(
        jsExport,
        nativeBinding
    );
    jsExport.AudioWorkletNode = require("./js/AudioWorkletNode.js")(
        jsExport,
        nativeBinding
    );
    jsExport.AnalyserNode = require("./js/AnalyserNode.js")(
        jsExport,
        nativeBinding
    );
    ...
    jsExport.BiquadFilterNode = require("./js/BiquadFilterNode.js")(
        jsExport,
        nativeBinding
    );
    jsExport.ChannelMergerNode = require("./js/ChannelMergerNode.js")(
        jsExport,
        nativeBinding
    );
    jsExport.ChannelSplitterNode = require("./js/ChannelSplitterNode.js")(
        jsExport,
        nativeBinding
    );
    jsExport.ConstantSourceNode = require("./js/ConstantSourceNode.js")(
        jsExport,
        nativeBinding
    );
    jsExport.ConvolverNode = require("./js/ConvolverNode.js")(
        jsExport,
        nativeBinding
    );
    jsExport.DelayNode = require("./js/DelayNode.js")(jsExport, nativeBinding);
    jsExport.DynamicsCompressorNode = require("./js/DynamicsCompressorNode.js")(
        jsExport,
        nativeBinding
    );
    jsExport.GainNode = require("./js/GainNode.js")(jsExport, nativeBinding);
    jsExport.IIRFilterNode = require("./js/IIRFilterNode.js")(
        jsExport,
        nativeBinding
    );
    jsExport.MediaStreamAudioSourceNode =
        require("./js/MediaStreamAudioSourceNode.js")(jsExport, nativeBinding);
    jsExport.OscillatorNode = require("./js/OscillatorNode.js")(
        jsExport,
        nativeBinding
    );
    jsExport.PannerNode = require("./js/PannerNode.js")(
        jsExport,
        nativeBinding
    );
    jsExport.StereoPannerNode = require("./js/StereoPannerNode.js")(
        jsExport,
        nativeBinding
    );
    jsExport.WaveShaperNode = require("./js/WaveShaperNode.js")(
        jsExport,
        nativeBinding
    );
    ...
    jsExport.PeriodicWave = require("./js/PeriodicWave.js")(
        jsExport,
        nativeBinding
    );
    jsExport.AudioBuffer = require("./js/AudioBuffer.js")(
        jsExport,
        nativeBinding
    );
